...
public static class SocketedJewelVisualClassifier
{
    ...
    public static SocketedJewelVisualKind Classify(string baseType, string name, string rawText)
    {
        foreach (var candidate in CandidateBaseNames(baseType, name, rawText))
        {
            ...
            var kind = candidate switch
            {
                ...
                "Ruby" or "Ruby Jewel" or "Time-Lost Ruby" or "Time-Lost Ruby Jewel" => SocketedJewelVisualKind.RubyJewel,
                "Emerald" or "Emerald Jewel" or "Time-Lost Emerald" or "Time-Lost Emerald Jewel" => SocketedJewelVisualKind.EmeraldJewel,
                "Sapphire" or "Sapphire Jewel" or "Time-Lost Sapphire" or "Time-Lost Sapphire Jewel" => SocketedJewelVisualKind.SapphireJewel,
    ...
    public static string? OverlayKey(SocketedJewelVisualKind kind, bool isExpansionSocket) =>
        kind switch
        {
            ...
            SocketedJewelVisualKind.RubyJewel => "Ruby",
            SocketedJewelVisualKind.EmeraldJewel => "Emerald",
            SocketedJewelVisualKind.SapphireJewel => "Sapphire",
            SocketedJewelVisualKind.Diamond => "Diamond",
            SocketedJewelVisualKind.TimeLost => "Time-Lost Diamond",
            SocketedJewelVisualKind.UnknownPoe2 => null,
            _ => null,
        };
