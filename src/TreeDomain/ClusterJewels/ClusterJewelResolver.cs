...
public static class ClusterJewelResolver
{
    ...
    public static ClusterSubgraph Resolve(TreeModel tree, Node socketNode, ClusterJewelSpec spec, int lineageIdBase, int clusterNodeIdBase)
    {
        ...
        void AddSocketNode(int templateIndex, int jewelIndex)
        {
            ...
            nodesByTemplateIndex[templateIndex] = AddNode(
                ...
                realSocket.Icon,
                realSocket.Stats,
                realSocket.ReminderText,
                realSocket.FlavourText,
        ...
        void AddNotableNode(int templateIndex, string notableName)
        {
            ...
            nodesByTemplateIndex[templateIndex] = AddNode(
                ...
                NodeType.Notable,
                baseNode?.Icon,
                baseNode?.Stats ?? Array.Empty<string>(),
                baseNode?.ReminderText ?? Array.Empty<string>(),
                baseNode?.FlavourText ?? Array.Empty<string>(),
                baseNode?.ActiveIcon,
        ...
        Node AddNode(
            ...
            IReadOnlyList<string> reminderText,
        ...
        string keystoneName)
    {
        ...
        var node = new Node
        {
            ...
            Y = y,
            Icon = template?.Icon,
            Stats = template?.Stats ?? Array.Empty<string>(),
            ReminderText = template?.ReminderText ?? Array.Empty<string>(),
            FlavourText = template?.FlavourText ?? Array.Empty<string>(),
